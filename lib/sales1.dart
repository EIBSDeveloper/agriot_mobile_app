...
//   Customer({required this.id, required this.name, this.village, this.shopName});
...
//     return Crop(id: json['id'], name: json['name'], img: json['img']);
//   }
// }
...
//     final response = await _httpService.post('/get_sales_by_crop/$farmerId/', {
//       'crop_id': cropId,
//       'type': type,
//     });
...
//   Future<SalesDetails> getSalesDetails({required int salesId}) async {
//     final farmerId = _appDataController.userId;
...
//   addSale({required Map<String, dynamic> data}) async {
//     final farmerId = _appDataController.userId;
...
//   updateSale({required int salesId, required Map<String, dynamic> data}) async {
//     final farmerId = _appDataController.userId;
//     return await _httpService.post(
...
//   deleteSale({required int salesId}) async {
//     final farmerId = _appDataController.userId;
//     return await _httpService.post('/deactivate_my_sale/$farmerId/', {
//       'id': salesId,
//     });
//   }
...
//       final details = await _repository.getSalesDetails(salesId: salesId);
...
//       if (salesId != null) {
//         await _repository.deleteSale(salesId: salesId);
//         Get.back();
...
//       if (isEditing.value) {
//         final salesId = salesDetails.value!.salesId;
//         await _repository.updateSale(salesId: salesId, data: data);
//         Get.back();
//         Get.snackbar('Success', 'Sale updated successfully');
//       } else {
//         await _repository.addSale(data: data);
//         Get.back();
...
//     return Deduction(
//       reason: selectedReason.value ?? Reason(id: 0, name: customReason.value!),
...
//                 items: [
//                   DropdownMenuItem(value: 1, child: Text('Coffee')),
//                   DropdownMenuItem(value: 2, child: Text('Tomato')),
//                 ],
//                 onChanged: (value) {
//                   if (value != null) {
...
//             children: [
//               Text('Total Sales', style: Get.textTheme.titleLarge),
//               Text(
...
//           children: [
//             Text(formattedDate.split(' ')[0], style: Get.textTheme.titleLarge),
//             Text(formattedDate.split(' ')[1], style: Get.textTheme.bodySmall),
//           ],
//         ),
...
//               crossAxisAlignment: CrossAxisAlignment.start,
//               children: [
//                 Text(sale.myCrop.name, style: Get.textTheme.titleLarge),
//                 Text(
...
//             _buildInfoRow(
//               'Gross Sales',
//               '₹${sale.salesAmount.toStringAsFixed(2)}',
//             ),
...
//     Get.dialog(Dialog(child: InteractiveViewer(child: Image.network(url))));
//   }
// }
...
//     return Obx(
//       () => DropdownButtonFormField<SalesUnit>(
...
//     return Obx(
//       () => TextFormField(
//         controller: TextEditingController(text: controller.amountPerUnit.value),
//         decoration: const InputDecoration(
...
//     return Obx(
//       () => DropdownButtonFormField<Rupee>(
//         value: controller.selectedRupee.value,
//         items: selescontroler.rupees
//             .map(
//               (rupee) =>
//                   DropdownMenuItem(value: rupee, child: Text(rupee.name)),
//             )
//             .toList(),
...
//           border: OutlineInputBorder(),
//         ),
//         validator: (value) => value == null ? 'Please select currency' : null,
//       ),
//     );
//   }
