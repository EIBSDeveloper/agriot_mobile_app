...
class UpdateEmployeePayoutsView extends GetView<UpdateEmployeePayoutsController> {
  ...
  Widget build(BuildContext context) => Scaffold(
      appBar: AppBar(
        title: Text('update_employee_payouts'.tr),
        centerTitle: true,
      ),
      body: Obx(() {
        ...
        if (controller.errorMessage.value.isNotEmpty && controller.employeeData.value == null) {
          return Center(
            child: Column(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildInfoRow('advance_amount'.tr, '₹${data.advanceAmount}'),
              _buildInfoRow('balance_advance'.tr, '₹${data.balanceAdvance}'),
            ],
          ),
        ),
      );
        ...
        children: [
          ...
          Expanded(
            child: ElevatedButton(
              onPressed: controller.isLoading.value ? null : controller.updatePayouts,
