...
import '../../widgets/dialogwidget/customerDialogWidget.dart';
...
class CustomerSalesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(isPayable ? 'Customer Payables' : 'Customer Receivables'),
      ),
      body: Obx(() {
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                Text(
                                  "Total: ₹${sale.totalSalesAmount} | Paid: ₹${sale.amountPaid}",
