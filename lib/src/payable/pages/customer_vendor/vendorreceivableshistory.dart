...
class VendorReceivableHistoryPage extends StatelessWidget {
  final int vendorId;
  final int purchaseId;
  final String type;

  VendorReceivableHistoryPage({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (controller.vendorReceivablesHistory.isEmpty) {
          return const Center(
            child: Text(
              "No history found",
        ...
        return ListView.builder(
          ...
          itemCount: controller.vendorReceivablesHistory.length,
          itemBuilder: (context, index) {
            final item = controller.vendorReceivablesHistory[index];
            return Card(
  ...
  void _showDetailDialog(
    VendorReceivableHistoryModel item,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildRow("Date", item.receivedDate),
              _buildRow("Balance", item.balance),
              _buildRow("Received", item.received),
              _buildRow("Payment", item.paymentAmount),
              _buildRow("To Receive", item.toReceive),
