...
#   path('add_farmer', manage_farmer, name='add_farmer'),
    ...
    # path('edit_farmer/<int:id>', edit_farmer, name='edit_farmer'),
...
name='get_inventory_items_by_category'),
    ...
    path('notification_read_all/<int:farmer_id>', mark_notification_read_all, name='mark_notification_read_all'),
...
#bala 
    ...
    path('employee/payouts/details/<int:employee_id>', get_employee_payout_details, name='get_employee_details'),
